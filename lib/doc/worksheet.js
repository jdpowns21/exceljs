    ...
    const image = {
      ...
      range: {
        tl: {
          col: range.tl.col,
          row: range.tl.row,
          colOff: range.tl.colOff || 0,
          rowOff: range.tl.rowOff || 0,
        },
        br: {
          col: range.br.col,
          row: range.br.row,
          colOff: range.br.colOff || 0,
          rowOff: range.br.rowOff || 0,
        },
      },
      ext: {
        cx: range.ext ? range.ext.cx : 0,
        cy: range.ext ? range.ext.cy : 0,
      },
      editAs: range.editAs,
      hyperlinks: range.hyperlinks,
    };
    this._media.push(new Image(this, image));
    return this;
  }
